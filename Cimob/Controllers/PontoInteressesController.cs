...
namespace Cimob.Controllers
{
    public class PontoInteressesController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Index([Bind("Id")] PontoInteresse pontoInteresse)
        {
            var applicationDbContext = await _context.PontoInteresse.SingleOrDefaultAsync(c => c.Id.Equals(pontoInteresse.Id));
            ViewBag.Pontos = new SelectList(_context.PontoInteresse, "Id", "Nome");
            return View(applicationDbContext);
        }
    }
