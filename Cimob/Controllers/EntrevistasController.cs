    ...
    public class EntrevistasController : Controller
    {
        ...
        {           
            ...
            if (User!=null)
            {
                ...
                await _emailSender.SendEmailAsync(user.Result.Email, " CIMOB - Candidaturas", "Foi Marcada uma entrevista para o dia " + entrevista.Data.ToString("dd") + " de " + entrevista.Data.ToString("MMMM") + " de " + entrevista.Data.ToString("yyyy") + " para a hora " + entrevista.Hora + ". Caso não possa comparecer contacte 265 790 159 para nova marcação");
